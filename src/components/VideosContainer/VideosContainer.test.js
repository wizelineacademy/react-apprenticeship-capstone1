...
const mockVideos = [
  ...
  },
  {
    ...
    snippet: {
      ...
      description:
        'React.js es una librería para crear interfaces web, con ella están construidas las dos redes sociales más grandes: Facebook e ...',
      thumbnails: {
        default: {
  ...
  },
  {
    ...
    snippet: {
      ...
      description:
        'EXPO, SDK De React para desarrollo de Apps Link ➞ https://bit.ly/3jdjnST Aprende a crear aplicaciones web Frontend usando ...',
      thumbnails: {
        default: {
  ...
  },
  {
    ...
    snippet: {
      ...
      title:
        'CHEZAME &amp; SXIN React | D-low | Judge Show | Beatbox To World Live 2021',
      description:
        'Chezame and SXIN react to @Korea Beatbox TV @Dlow Beatbox Get your Merch at: https://clop-shop.com Subscribe to @SXIN ...',
      thumbnails: {
        default: {
  ...
  },
  {
    ...
    snippet: {
      ...
      description:
        "Bro actually it was 4/3 lol long bc i cut the Epicsode but it got banned probably I'm not allowed to use it well anyways sorry if it's ...",
      thumbnails: {
        default: {
  ...
  },
  {
    ...
    snippet: {
      ...
      description:
        "Do parents know popular teen slang? Watch to find out and see their teens' reactions. Check out more episodes of Teens and ...",
      thumbnails: {
        default: {
  ...
  },
  {
    ...
    snippet: {
      ...
      description:
        'We react to the top 5 deadliest female serial killers of all time from all over the world. Check out more true crime reactions here: ...',
      thumbnails: {
        default: {
  ...
  },
  {
    ...
    snippet: {
      ...
      title:
        'Spider-Man’s and Gf’s react to each other [TikTok’s]|Toby|1/3{PeterMj}',
      description: '',
      thumbnails: {
        default: {
  ...
  },
  {
    ...
    snippet: {
      ...
      description:
        'Learn the basics of React in this comprehensive course. You will learn about fundamentals, hooks, context API, react router, ...',
      thumbnails: {
        default: {
  ...
  },
  {
    ...
    snippet: {
      ...
      description:
        'Try To Keep Eating While Watching Challenge Reacted to by Teens. Original links below. Join the SuperFam and support FBE: ...',
      thumbnails: {
        default: {
  ...
  },
  {
    ...
    snippet: {
      ...
      description:
        'Video Link:https://youtu.be/Yp5nPGWWMh4 This Video was Inspired  : by:@Frostieso.',
      thumbnails: {
        default: {
...
describe('VideosContainer Component', () => {
  ...
  test('After fetching data print Cards', async () => {
    mockisLoading = false;
    act(() => {
      render(
        <Router>
    ...
    const videoContainer = screen.getByTestId('test-div-container');
    expect(videoContainer).toBeInTheDocument();

    const divs = within(videoContainer).getAllByRole('heading');
