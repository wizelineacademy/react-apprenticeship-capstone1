...
function Header(props) {
    ...
    return (
        <section className={'header ' + props.className}>
            <IconButton icon={<FontAwesomeIcon icon={['fas', 'bars']} size='2x' />} className='header__icon_button'/>
            <div className={'header__search-bar-container'}>
                <Searchbar 
                    className={searchBarFocus ? 'header__search-bar header__search-bar--grow' : 'header__search-bar' } 
