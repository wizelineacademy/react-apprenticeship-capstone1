    ...
    return(
        ...
        <header>
            <div className={classes['header-container']}>
                ...
                <Link to="/" className={classes['header-logo']} data-testid="logo">Dark<span>Beat</span></Link>

                <div className={classes.header__utilities}>

                    <button className={classes['favorites-button']} onClick={props.onFavoritesToggle} name="Favorites">
                        <i className={classes.icon}></i>
                        <span className={classes['button-text']} >Favorites</span>
                    </button>

                    <button className={classes['search-button']} onClick={onSearchToggle} name="Search">
                        <i className={classes.icon}></i>
                        <span className={classes['button-text']}>Search</span>
                    </button>

                    <button className={classes['login-button']} onClick={props.onLoginToggle} name="Login">
                        <i className={classes.icon}></i>
